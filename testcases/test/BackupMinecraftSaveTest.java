...
public class BackupMinecraftSaveTest
{
  ...
  public void testCreateBackupSave() throws Exception {
    ...
    success = BackupMinecraftSave.createBackupSave(Paths.get(PREMADE_TEST_1), testFolderRootBk, "Test");
    Assert.assertTrue("createBackupSave succeeds", success);
    Assert.assertTrue(Files.exists(testFolderRootBk));

    success = BackupMinecraftSave.isBackupSaveUnmodified(testFolderRootBk);
    Assert.assertTrue("isBackupSaveUnmodified is true", success);

    success = BackupMinecraftSave.deleteBackupSave(testFolderRootBk);
