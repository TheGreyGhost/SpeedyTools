...
//  {
//    CloneToolsNetworkClient cloneToolsNetworkClient = ClientSide.getCloneToolsNetworkClient();
...
////    checkInvariants();
////    CloneToolsNetworkClient cloneToolsNetworkClient = ClientSide.getCloneToolsNetworkClient();
////    ResultWithReason success = cloneToolsNetworkClient.performToolUndo();
////
...
////  {
////    checkInvariants();
////    ResultWithReason success = ClientSide.getCloneToolsNetworkClient().performToolAction(itemID,
...
////      }
////    }
////    ClientSide.getCloneToolsNetworkClient().informSelectionMade();
////  }
//
