...
{
  public SpeedyToolComplexBase(ItemSpeedyTool i_parentItem, SpeedyToolRenderers i_renderers, SpeedyToolSounds i_speedyToolSounds,
  ...
  protected MovingObjectPosition boundaryFieldFaceSelection(EntityLivingBase player)
  {
    ...
    AxisAlignedBB boundaryField = AxisAlignedBB.getBoundingBox(boundaryCorner1.posX, boundaryCorner1.posY, boundaryCorner1.posZ,
