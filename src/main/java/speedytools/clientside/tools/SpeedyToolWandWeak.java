...
{
  public SpeedyToolWandWeak(ItemSpeedyTool i_parentItem, SpeedyToolRenderers i_renderers, SpeedyToolSounds i_speedyToolSounds, UndoManagerClient i_undoManagerClient)
  {
  ...
  {
    return selectLineOfBlocks(target, player, maxSelectionSize, BlockMultiSelector.CollisionOptions.STOP_WHEN_SOLID_BLOCK_REACHED, partialTick);
  }

  @Override
  protected void playPlacementSound(Vec3 playerPosition)
  {
    speedyToolSounds.playSound(SpeedySoundTypes.WEAKWAND_PLACE, playerPosition);
  }

  @Override
  protected void playUndoSound(Vec3 playerPosition)
  {
    speedyToolSounds.playSound(SpeedySoundTypes.WEAKWAND_UNPLACE, playerPosition);
  }
}
