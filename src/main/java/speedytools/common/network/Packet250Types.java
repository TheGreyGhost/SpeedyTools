...
public enum Packet250Types
{
  ...
  PACKET250_TEST_HARNESS(35),
  PACKET250_TEST_HARNESS_ACK(36);
  ...
  public Packet250Types getPairedType()
  {
    switch(this) {
      ...
      case PACKET250_TEST_HARNESS: { return PACKET250_TEST_HARNESS_ACK;}
      case PACKET250_TEST_HARNESS_ACK: { return PACKET250_TEST_HARNESS;}
      default: { return null;}
    }
  }
